...
def test_single_node(conn):
    ...
    cs = collect_changesets_tags(conn, "tags ? 'tag'")
    assert cs == set([10090, 10091, 10092])

    cs = collect_changesets_tags(conn, "tags->'tag' like 'value_'")
    assert cs == set([10090, 10091])

    cs = collect_changesets_tags(conn, "tags->'tag' = 'value1'")
    assert cs == set([10090])

    cs = collect_changesets_tags(conn, "tags->'tag' = 'value2'")
    assert cs == set([10091])

    cs = collect_changesets_tags(conn, "tags ? 'foo' and tags ? 'tag'")
    assert cs == set([10092])
...
def test_way_nodes(conn):
    ...
    cs = collect_changesets_tags(conn, "tags ? 'highway'")
    assert cs == set([10091, 10095])
...
def test_relation_relation_way_node(conn):
    ...
    assert cs == set([10091, 10092, 10093])
